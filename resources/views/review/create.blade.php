    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-1 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:min-w-sm">
                <h2 class="text-center text-2xl/9 font-bold tracking-tight text-gray-900">New Review</h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="{{ route('review.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="title" type="text" name="title" required autocomplete="title"
                    ...
                    <div class="flex flex-row space-x-3">
                        <div class="flex-2">
                            ...
                            <div class="mt-2">
                                <input id="movie" type="text" name="movie" required autocomplete="movie"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-rose-700 sm:text-sm/6" />
                            </div>
                        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-2">
                                <input id="year" type="number" name="year" required autocomplete="year"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-rose-700 sm:text-sm/6" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea id="body" type="text" name="body" required autocomplete="body" rows="4"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-rose-700 sm:text-sm/6"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 mb-15">
                        ...
                        <input name="rating" type="range" class="w-full" min="1" max="10" step="0.5" value="1" class="bg-rose-600" />
                    ...
                    <div>
                        <button type="submit"
                            class="cursor-pointer flex w-full justify-center rounded-md bg-rose-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-rose-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-700">Post
                            review</button>
                    </div>
                </form>
            </div>
